...
public class UserCreatedEventConsumer {
    ...
    public void consumeCreatedUserEvent(@Payload UserCreatedEvent eventData,
        ...
        Notification entity = eventToNotificationEntity(eventData);

        notificationService.save(entity);

    }

    private Notification eventToNotificationEntity(UserCreatedEvent userCreatedEvent){
        Notification notification = new Notification();
        notification.setUserId(userCreatedEvent.getId());
        notification.setEmail(userCreatedEvent.getEmail());
        notification.setIsSend(Boolean.TRUE);
        return notification;
    }
}
